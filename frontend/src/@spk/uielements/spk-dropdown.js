  ...
  return (
    <Fragment>
      <div className={`hs-dropdown ti-dropdown    ${Customclass}`}>
        {Linktag ? (
          ...
          >
            {iconPosition === "before" ? (
              <>
                {Imagetag ? (
                  <img src={Image} alt={Imagename} className={Imageclass} />
                ) : (
                  <>{Icon ? <i className={IconClass}></i> : ""}</>
                )}
                <p className="">{Toggletext}</p>
              </>
            ) : (
              <div>
                {Toggletext}
          ...
          <SpkButton
            size={Size}
            customClass={`ti-btn ${CustomToggleclass}`}
            variant={color}
            buttontype="button"
            Id={buttonid}
            Expand={arialexpand}
        ...
        <ul
          className={`hs-dropdown-menu ti-dropdown-menu hidden  ${Custommenuclass}`}
